...
const ResourcesPage = () => {
  const programmingLanguages = [
    ...
    },
    {
      ...
      notesLink: 'https://drive.google.com/drive/folders/1Orhb-YbIH1SCuoTi_pVaWBI0-gLM8RPQ',
    },
    {
      name: 'DSA',
      icon: '🧮',
      ...
      notesLink: 'https://github.com/Mohan-parimi/Data-Structures-and-Algorithms-Notes',
    },
  ];
